...
const MALICIOUS_DOMAINS = [
  "porn", "sex", "xxx", "redtube", "xvideos", "xnxx", "hentai", "youporn", "brazzers", "camgirl", "cam4", "chaturbate", "xhamster", "spankbang", "tnaflix", "fapdu", "erotic", "escort", "bet365", "casino", "phishing", "malware", "virus"
];
...
export default function CrearEventoPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setError("");
    setSuccess("");
    if (!form.title || !form.description || !form.price || (!form.date && form.days.length === 0) || !form.city || !form.address) {
      setError("Por favor, completa todos los campos obligatorios.");
      return;
    }
    if (form.image && !isSafeUrl(form.image)) {
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <Input name="title" value={form.title} onChange={handleChange} required maxLength={80} placeholder="Nombre del evento" />
            </div>
            <div>
              <label className="block font-medium mb-1 text-primary">URL de imagen</label>
              <Input name="image" value={form.image} onChange={handleChange} placeholder="https://..." type="url" />
            ...
            <div className="flex gap-4">
              ...
              <div className="flex-1">
                ...
                <Input name="capacity" value={form.capacity} onChange={handleChange} type="number" min={0} placeholder="Ej: 30" />
              </div>
            </div>
            <div className="flex gap-4">
              <div className="flex-1">
            ...
            <Button type="submit" size="lg" className="w-full">Crear evento</Button>
          </form>
        </CardContent>
      </Card>
    </div>
